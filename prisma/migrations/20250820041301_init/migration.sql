...
-- DropForeignKey
ALTER TABLE "public"."User" DROP CONSTRAINT "User_userAddressId_fkey";
...
-- AddForeignKey
ALTER TABLE "public"."Customer" ADD CONSTRAINT "Customer_addressId_fkey" FOREIGN KEY ("addressId") REFERENCES "public"."CustomerAddress"("id") ON DELETE SET NULL ON UPDATE CASCADE;
